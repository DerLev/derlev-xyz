...
const GoogleSvg = ({ colorless }: SvgProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width=".98em" height="1em" viewBox="0 0 186.69 190.5">
    <g transform="translate(1184.583 765.171)" filter={ colorless ? 'url(#grayscale)' : '' }>
